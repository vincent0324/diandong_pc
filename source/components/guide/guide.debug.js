...
var Guide = function () {
    ...
    _createClass(Guide, [{
        ...
        value: function bindEvent() {
            ...
            (0, _jquery2.default)('.filter-sub-tab a').on('mouseenter', function () {
                var index = (0, _jquery2.default)(this).parent('.filter-sub-tab').find('a').index(this);
                var tabContent = (0, _jquery2.default)(this).parents('.filter-sub-tab').siblings('.filter-sub-tabcon');

                (0, _jquery2.default)(this).addClass('current').siblings('a').removeClass('current');
                tabContent.addClass('fn-hide').eq(index).removeClass('fn-hide');
            });

            (0, _jquery2.default)('.filter-super-tab a').on('click', function () {
                var index = (0, _jquery2.default)(this).parent('.filter-super-tab').find('a').index(this);
                var tabContent = (0, _jquery2.default)(this).parents('.filter-super-tab').siblings('.filter-super-tabcon');
        ...
        key: 'guideSwiper',
        value: function guideSwiper() {
            var guideSwiper = new _swiper2.default('.guide-photo-container', {
                loop: true,
                grabCursor: true,
            ...
            (0, _jquery2.default)('.guide-photo-prev').on('click', function (e) {
                e.preventDefault();
                guideSwiper.swipePrev();
            });

            (0, _jquery2.default)('.guide-photo-next').on('click', function (e) {
                e.preventDefault();
...
var _Guide = __webpack_require__(0);
