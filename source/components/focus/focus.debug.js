...
var imageSlider = {
    elements: {
        focusPage: (0, _jquery2.default)('.focus-pages span'),
        focusSlideItem: (0, _jquery2.default)('.focus-display-item'),
        focusPrev: (0, _jquery2.default)('.focus-ctrl-prev'),
        focusNext: (0, _jquery2.default)('.focus-ctrl-next'),
        focusDisplayBox: (0, _jquery2.default)('.focus-display'),
        focusImg: (0, _jquery2.default)('.focus-display-item img')
    },
    focusLength: 0,
    focusIndex: 0,
    focusTime: null,
    ...
    bindEvent: function bindEvent() {
        ...
        (0, _jquery2.default)(document).on('click', '.focus-pages span', function (e) {
            var index = (0, _jquery2.default)('.focus-pages span').index(this);
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!./focus.css", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!./focus.css");
...
var _Focus = __webpack_require__(0);
